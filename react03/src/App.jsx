  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem){
        return <Card company={elem.companyName} post={elem.post} jobtype={elem.tag1} level={elem.tag2} time={elem.datePosted} pay={elem.pay} place={elem.location} immg={elem.brandLogo}/>
      })}
